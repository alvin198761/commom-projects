        ...
        <el-row :gutter="20" style="margin-top: 20px;">
            <el-col :span="16">
                <el-card  >
                    ...
                    <el-table size="small">
                        ...
                        <el-table-column label="数据权限" width="120"></el-table-column>
                        <el-table-column label="权限角色" width="80"></el-table-column>
                        <el-table-column label="角色级别" width="120"></el-table-column>
            ...
            <el-col :span="8">
                <el-card  >
                    <div slot="header">
                        <span>菜单分配</span>
                        <el-button type="primary" style="float: right; " icon="el-icon-check" size="small">保存</el-button>
                    </div>
                    <el-tree ref="deptTree" empty-text="没有数据" :expand-on-click-node="false" show-checkbox
                             default-expand-all :data="roleTreeDataList" :props="defaultProps"
                             @node-click="deptTreeNodeClick">
                    </el-tree>
                </el-card>
            </el-col>
        </el-row>
        <RoleDialog ref="dialog" :refresh="globalRefresh"></RoleDialog>
    </div>
</template>
<script>
