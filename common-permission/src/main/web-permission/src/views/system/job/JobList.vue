    ...
    <div>
        ...
        <div style="margin-top: 20px;">
            <el-table size="small" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" row-key="id">
                ...
                <el-table-column label="所属部门" width="300"></el-table-column>
                <el-table-column label="排序" width="120"></el-table-column>
                <el-table-column label="状态" width="150">
                    <template slot-scope="props">
                        <el-switch v-model="props.row.status"></el-switch>
                    </template>
                </el-table-column>
                <el-table-column label="创建日期" width="450">
        ...
        <JobDialog ref="dialog" :refresh="globalRefresh"></JobDialog>
    </div>
</template>
<script>
