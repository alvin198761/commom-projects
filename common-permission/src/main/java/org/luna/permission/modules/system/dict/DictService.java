...
import org.luna.permission.modules.system.detail.Detail;
import org.luna.permission.modules.system.detail.DetailCond;
import org.luna.permission.modules.system.detail.DetailDao;
...
public class DictService {
    ...
    public int save(Dict dict) {
        ...
        cond.setNameEq(dict.getName());
        if (this.queryCount(cond) > 0) {
            throw new ValidationException("字典名称已经存在");
        }
    ...
    public int delete(Long id) {
        DetailCond cond = new DetailCond();
        cond.setDictId(id);
        if (this.detailDao.queryCount(cond) > 0) {
            throw new ValidationException("请先删除子项");
        }
